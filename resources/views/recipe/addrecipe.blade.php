...
@section('content')
<div class="flex flex-col py-6 md:py-10 overflow-y-auto w-full bg-gradient-to-b from-amber-50/30 to-orange-50/30">
    <div class="max-w-4xl mx-auto w-full px-4">
        ...
        <!-- Form Card -->
        <form action="{{ route('recipe.store') }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-2xl shadow-xl border border-amber-100 overflow-hidden">
            @csrf
